...
-Ожидаемый результат: оплата успешно прошла, появляется сообщение об успешно выполненной операции - "Успешно" + "Операция одобрена Банком"

### 3. Отправка формы оплаты по APPROVED карте с заполнением поля "Владелец" с двойным именем и фамилией через тире
- Предусловия: открыта страница http://localhost:8080/
...
### 6. Отправка формы с указанием следующего месяца от текущего и текущего года
...
### 5. Отправка формы оплаты с пустым полем "Владелец"
...
- Написание автотестов, с учетом рисков - 30-35ч.(сделано)
- Составление отчетов, при необходимости баг-репортинг - 5-6ч.(сделано)

## План сдачи работ: сроки проведения автотестов, результаты их проведения и отчёт по автоматизации
- Ручное тестирование, составление баг-репортов - 21.10.2024
- Написание, проведение автотестов - до 30.10.2024
- Отчет по итогам тестирования - 02.11.2024
- Отчет по автоматизации - 10.11.2024